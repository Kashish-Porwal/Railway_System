...
int fareofbooking(int *fare, int class){
    ...
    *fare = total_fare;
    ...
    fprintf(filePointer,"Transaction ID :  %d \nIR recovers only 57 percent of cost of travel on an average\n\nPayment Details\n");
...
void trainfunction(char** ArrivalStation, int* total_fare, int* class){
 ...
 // printf("%s",*ArrivalStation);
    ...
    else if(*ArrivalStation == "Kurla Junction" || *ArrivalStation == "Ayodhya Junction" || *ArrivalStation == "Varanasi Junction" || *ArrivalStation == "Ujjain Junction" || *ArrivalStation == "Amritsar Junction" || *ArrivalStation == "Patiala" || *ArrivalStation == "Jalandhar"){
...
int main(){
    ...
    switch(Operation){
        ...
        case 1:
            ...
            *DestinationState = States(&DestinationStation);

            Station_Details(&ArrivalStation,&DestinationStation);


            if (strcmp(*arrivalState,*DestinationState) == 0){
                if(strcmp(ArrivalStation,DestinationStation) == 0){
